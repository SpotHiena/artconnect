...
<head>
  ...
  <title>Art Connect - Usuários Cadastrados</title>
...
<body>
        ...
        <div class="container mt-5">
          <div class="card">
            <div class="card-header d-flex justify-content-between aling-items-center">
              <h4 class="m-0">Usuarios Cadastrados</h4>

              <a href="inserir.php" class="btn btn-primary btn-sm">Adicionar Usuario</a>
            </div>
            ...
            <div class="card-body">
              <div class="row p-3">
                ...
                <div class="col-lg-3">
                  <input type="search" name="pesquisa2" id="pesquisa2" class="form-control" placeholder="Pesquise por apelido...">
                </div>
              </div>
  ...
  <script>
    ...
    function listar(sexo, status, nome, apelido) {
    ...
    function buscar() {
      ...
      listar(gender, stts, nome, apelido);
    }
